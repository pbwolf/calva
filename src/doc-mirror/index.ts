...
export class DocumentModel implements EditableModel {
  ...
  documentVersion: number; // model is in sync with this version upon processing TextDocumentChangeEvent
  staleDocumentVersion: number; // model is out-of-date because of edits queued from this version
